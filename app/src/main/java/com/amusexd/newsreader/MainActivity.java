package com.amusexd.newsreader;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateListView() {
        ...
        if (c.moveToFirst()) {
            ...
            Log.i("moveToFirst ","Not moveToFirst");
        }
    ...
    public class DownloadTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                Log.i("Print numberOfItems", numberOfItems + ": numberOfItems");

                for (int i = 0; i < numberOfItems; i++) {
                    Log.i("Print Current", i + ": i");
                    ...
                    Log.i("article info Object", "Bollean" + jsonObject.isNull("title"));
